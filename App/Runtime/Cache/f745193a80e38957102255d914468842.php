...
<center>
	...
	<div style="margin-bottom:20px">
	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href=__UPLOADS__/<?php echo ($vo["imgfile1"]); ?> target="_blank" >查看图片</a>
		<a href="javascript:void(0)" class="easyui-linkbutton" onclick="myimage(1)">上传图片</a><?php endforeach; endif; else: echo "" ;endif; ?>
	</div>	
