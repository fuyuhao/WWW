...
<table id="bt_news_grid"></table>
<script type="text/javascript"> NameSpace("BT.NEWS", function() { var context = this; ﻿var $grid = $('#bt_news_grid'), viewDialog, $typeGrid;
...
context.updateView = function(uid) {
	...
	$('#bt_index_layout_center').panel('open').panel('refresh',_ROOT_ +'/news/addprice?nid=' + uid);
};
