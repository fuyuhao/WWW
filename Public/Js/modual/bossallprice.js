...
context.ready = function() {
    $grid.datagrid({
        fit: true,
        idField: 'priceid',
        url: _ROOT_ + '/bossview/getallPrice',
        pagination: true,
        columns: [[
                {checkbox: true},
				...
				{field: 'prate', title: '产品单价(元)', width: 130, align: 'center',sortable:'true'},
...
var addView = function() {
    ...
    //window.open(myurl);   
	$('#bt_index_layout_center').panel('open').panel('refresh',_ROOT_ +'/bossview/sumprice');
};
